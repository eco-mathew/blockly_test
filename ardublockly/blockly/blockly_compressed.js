...
Blockly.Bubble.prototype.anchorXY_ = 0;
...
Blockly.Mutator.prototype.resizeBubble_ = function() {    // block 추가/제거하는 기능이 실행되는
...
Blockly.RenderedConnection.prototype.tighten_ = function() {    // 블록을 연결하는 위치 설정
...
Blockly.RenderedConnection.prototype.highlight = function() {
  var a;
  a = this.type == Blockly.INPUT_VALUE || this.type == Blockly.OUTPUT_VALUE ? "m -0.5,-0.5 " + Blockly.BlockSvg.TAB_PATH_DOWN + " v 2" : "m -20,0 h 5 " + Blockly.BlockSvg.NOTCH_PATH_LEFT + " h 5";
...
Blockly.BlockSvg.SEP_SPACE_X = 13;
Blockly.BlockSvg.SEP_SPACE_Y = 20;
Blockly.BlockSvg.INLINE_PADDING_Y = 6;
Blockly.BlockSvg.MIN_BLOCK_Y = 25;
Blockly.BlockSvg.TAB_HEIGHT = 24;
Blockly.BlockSvg.TAB_WIDTH = 8;
Blockly.BlockSvg.NOTCH_WIDTH = 23;
...
Blockly.BlockSvg.NOTCH_PATH_LEFT = "l 3,6 9,0 3,-6";
Blockly.BlockSvg.NOTCH_PATH_LEFT_HIGHLIGHT = "l 3,6 9,0 3,-6";
Blockly.BlockSvg.NOTCH_PATH_RIGHT = "l -3,6 -9,0 -3,-6";
Blockly.BlockSvg.JAGGED_TEETH = "l 8,0 0,4 8,4 -16,8 8,4";
Blockly.BlockSvg.JAGGED_TEETH_HEIGHT = 20;  // 블록 접었을 때 높이
Blockly.BlockSvg.JAGGED_TEETH_WIDTH = 15;  // 블록 접었을 때 길이
Blockly.BlockSvg.TAB_PATH_DOWN = "v 3 l -6 5, 0 10, 6 5 v 1";
...
Blockly.BlockSvg.prototype.render = function(a) {
  Blockly.Field.startCache();
  this.rendered = !0;
  var b = Blockly.BlockSvg.SEP_SPACE_X;   // 너비 확인 후 변수에 저장
  this.RTL && (b = -b);                   // RTL일 경우, 값을 반대로 저장
  ...
  for (var d = 0, e = 0, f = !1, g = !1, h = !1, k = void 0, l = this.getInputsInline() && !this.isCollapsed(), p = 0, m; m = b[p]; p++)
    if (m.isVisible()) {
      ...
      l && k && k != Blockly.NEXT_STATEMENT && m.type != Blockly.NEXT_STATEMENT ? q = c[c.length - 1] : (k = m.type, q = [], q.type = l && m.type !=
        Blockly.NEXT_STATEMENT ? Blockly.BlockSvg.INLINE : m.type, q.height = 10, c.push(q));
      q.push(m);
...
Blockly.BlockSvg.prototype.renderDrawRight_ = function(a, b, c, d, e, f, g) {
  for (var h, k = 0, l, p, m = 0, q; q = f[m]; m++) {
    ...
    if (this.isCollapsed()) {
      ...
      2 * Blockly.BlockSvg.SEP_SPACE_X, n.align == Blockly.ALIGN_RIGHT ? h += r : n.align == Blockly.ALIGN_CENTRE && (h += r / 2)), this.renderFields_(n.fieldRow, h, l), h = f.statementEdge + Blockly.BlockSvg.NOTCH_WIDTH, a.push("H", h), a.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER), a.push("v", q.height - 2 * Blockly.BlockSvg.CORNER_RADIUS + 5), a.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER), a.push("H", f.rightEdge), this.RTL ? (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + Blockly.BlockSvg.DISTANCE_45_OUTSIDE)),
      b.push(Blockly.BlockSvg.INNER_TOP_LEFT_CORNER_HIGHLIGHT_RTL), b.push("v", q.height - 2 * Blockly.BlockSvg.CORNER_RADIUS), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_RTL)) : (b.push("M", h - Blockly.BlockSvg.NOTCH_WIDTH + Blockly.BlockSvg.DISTANCE_45_OUTSIDE + "," + (k + q.height - Blockly.BlockSvg.DISTANCE_45_OUTSIDE) + 3.5), b.push(Blockly.BlockSvg.INNER_BOTTOM_LEFT_CORNER_HIGHLIGHT_LTR)), b.push("H", f.rightEdge - .5), l = e.x + (this.RTL ? -h : h + 1), p = e.y + k + 1, n.connection.moveTo(l, p), n.connection.isConnected() && (n.connection.tighten_(),
      this.width = Math.max(this.width, f.statementEdge + n.connection.targetBlock().getHeightWidth().width)), m == f.length - 1 || f[m + 1].type == Blockly.NEXT_STATEMENT) && (a.push("v", Blockly.BlockSvg.SEP_SPACE_Y - 5), this.RTL && b.push("v", Blockly.BlockSvg.SEP_SPACE_Y), k += Blockly.BlockSvg.SEP_SPACE_Y);
    k += q.height
  }
...
Blockly.BlockSvg.prototype.renderDrawLeft_ = function(a, b, c, d) {
  this.outputConnection ? (this.outputConnection.moveTo(c.x, c.y), a.push("v -1.0"), a.push("l -6 -4.5, 0 -9.5, 6 -5.5"), this.RTL ? (b.push("M", -.25 * Blockly.BlockSvg.TAB_WIDTH + ",8.4"), b.push("l", -.45 * Blockly.BlockSvg.TAB_WIDTH + ",-2.1")) : this.width += Blockly.BlockSvg.TAB_WIDTH) : this.RTL || (this.squareTopLeftCorner_ ? b.push("V", .5) : b.push("V", Blockly.BlockSvg.CORNER_RADIUS));
  a.push("z")
};
Blockly.Events = {};
...
Blockly.Toolbox.prototype.populate_ = function(a) {
  function b(a, g, h) {
    for (var k = null, l = 0, p; p = a.childNodes[l]; l++)
      if (p.tagName) switch (p.tagName.toUpperCase()) {
        case "CATEGORY":
          k = c.createNode(p.getAttribute("name"));
          k.blocks = [];
          g.add(k);
          var m = p.getAttribute("custom");
          m ? k.blocks = m : b(p, k, h);
          m = p.getAttribute("colour");
          goog.isString(m) ? (m.match(/^#[0-9a-fA-F]{6}$/) ? k.hexColour = m : k.hexColour = Blockly.hueToRgb(m), e = !0) : k.hexColour = "";
          "true" == p.getAttribute("expanded") ? (k.blocks.length && c.setSelectedItem(k), k.setExpanded(!0)) :
            k.setExpanded(!1);
          k = p;
          break;
        case "SEP":
          k && ("CATEGORY" == k.tagName.toUpperCase() ? g.add(new Blockly.Toolbox.TreeSeparator(d.treeSeparatorConfig_)) : (p = parseFloat(p.getAttribute("gap")), isNaN(p) || (m = parseFloat(k.getAttribute("gap")), p = isNaN(m) ? p : m + p, k.setAttribute("gap", p))));
          break;
        case "BLOCK":
        case "SHADOW":
          g.blocks.push(p), k = p
...
Blockly.Css.CONTENT = [".blocklySvg {", "background-color: #fff;", "outline: none;", "overflow: hidden;", "}", ".blocklyWidgetDiv {", "display: none;", "position: absolute;", "z-index: 999;", "}", ".blocklyTooltipDiv {", "background-color: #ffffc7;", "border: 1px solid #ddc;", "box-shadow: 4px 4px 20px 1px rgba(0,0,0,.15);", "color: #000;", "display: none;", "font-family: nanumsquare;", "font-size: 9pt;", "opacity: 0.9;", "padding: 2px;", "position: absolute;", "z-index: 1000;", "}", ".blocklyResizeSE {", "cursor: se-resize;",
  ...
  "fill-opacity: .8;", "stroke-opacity: .8;", "}", ".blocklyDragging>.blocklyPathDark {", "display: none;", "}", ".blocklyDisabled>.blocklyPath {", "fill-opacity: .5;", "stroke-opacity: .5;", "}", ".blocklyDisabled>.blocklyPathLight,", ".blocklyDisabled>.blocklyPathDark {", "display: none;", "}", ".blocklyText {", "cursor: default;", "fill: #fff;", "font-family: nanumsquare;", "font-size: 11pt;", "}", ".blocklyNonEditableText>text {", "pointer-events: none;", "}", ".blocklyNonEditableText>rect,", ".blocklyEditableText>rect {",
